...
- No fast "best case"; every object will at least walk the tree enough to find
  itself, an average of `log2(n)-1`, or 14 tests for 10k objects.
...
the sweeping method to do far more than 14 tests per object along that column.
...
re-sort much more frequently in most cases. TODO: Find out how fast this
sorting is.
